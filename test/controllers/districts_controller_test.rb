...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { name: @district.name, rrange_id: @district.rrange_id } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { name: @district.name, rrange_id: @district.rrange_id } }
